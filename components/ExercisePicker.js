  ...
  return (
    <View style={[styles.container, style]}>
      <TextInput
        ...
        value={value?.name && value.source === 'builtin' ? value.name : ''}
...
const styles = StyleSheet.create({
  container: { width: '100%' },
  search: { height: 40, borderColor: '#ccd0d5', borderWidth: 1, paddingHorizontal: 8, borderRadius: 6, marginVertical: 6 },
  list: { maxHeight: 260 },
  item: { paddingVertical: 10, paddingHorizontal: 8 },
  itemText: { fontSize: 16 },
  customRow: { flexDirection: 'row', alignItems: 'center', marginTop: 6 },
  customInput: { flex: 1, height: 40, borderColor: '#ccd0d5', borderWidth: 1, paddingHorizontal: 8, borderRadius: 6 },
  applyBtn: { marginLeft: 8, paddingHorizontal: 12, paddingVertical: 8, backgroundColor: '#2a9d8f', borderRadius: 6 },
  applyText: { color: 'white' },
});
