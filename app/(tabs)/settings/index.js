      ...
      <View style={[styles.section, { borderColor: colors.border }]}>
        ...
        <View style={styles.themeRow}>
          {[
            ...
            <TouchableOpacity key={t.key} onPress={() => updateTheme(t.key)} style={[styles.themeOption, { borderColor: colors.border }, theme === t.key && { borderColor: colors.accent }]}>
      ...
      <View style={[styles.section, { borderColor: colors.border }]}>
        ...
        <View style={styles.themeRow}>
          {[
            ...
            <TouchableOpacity key={a.key} onPress={() => updateAccent(a.key)} style={[styles.themeOption, { borderColor: colors.border }, accent === a.key && { borderColor: colors.accent }]}>
...
const styles = StyleSheet.create({
  ...
  logoutBtn: { paddingVertical: 12, borderRadius: 8, alignItems: 'center', marginTop: 16 },
